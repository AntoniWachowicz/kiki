/**
 * Sound Generation Module (Legacy)
 * Original sound generation system - preserved for reference
...
/**
 * Main sound generation function (Legacy)
 ...
 */
export const generateSoundLegacy = async (audioContext, analysis, duration = 5, volume = 0.5) => {
  try {
